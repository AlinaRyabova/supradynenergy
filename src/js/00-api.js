...
export default class APIService {
    ...
    async getExercises(params1, params2){
        ...
        console.log(`${this.baseURL}exercises?${params1}=${params2}&page=1&limit=10`);
        const response = await axios.get(`${this.baseURL}exercises?${params1}=${params2}&page=1&limit=10`);
